  ...
  return (
    <div className="relative bg-slate-900 text-white overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-emerald-500 rounded-full mix-blend-multiply filter blur-xl opacity-10 animate-pulse animation-delay-2000"></div>
      </div>
    </div>
  );
}
